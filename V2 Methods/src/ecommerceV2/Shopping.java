...
public class Shopping {
	...
	void Menswear()
	{
		...
		System.out.println("Mens: Discount 10%"+'\n');
	...
	void Womenswear()
	{
		...
		System.out.println("Womens: Discount 25%"+'\n');
	...
	void Kids()
	{
		...
		System.out.println("Kids: Discount 30%"+'\n');
	...
	void Beauty()
	{
		...
		String offer = "offers starts@15% - 25%";
