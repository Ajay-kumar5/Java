...
public class Healthcare {
	...
	int Medicines0ffer = 15;
	int Doctor_Timing_Starts = 9;
	int Doctor_Timing_End = 10;
	
	String a = "upto 45% off";
	String b = "upto 20% off";
	String c = "upto 30% off";
	
	Healthcare(String Username,int ID)
	{
		...
		System.out.println("Username: "+Username+'\t'+'\t'+"ID:"+ID+'\t'+'\t'+offer+'\t'+'\t'+Cart+'\n'+'\n'); 
	}
	...
	void MedicinesTypes()
	{
		...
		System.out.println(Orate+Medicines0ffer+"%"+'\n');
		...
		void Healthcare()
		{
			...
			System.out.println(Elder+'\t'+'\t'+a);
			System.out.println(Personal+'\t'+'\t'+a);
			System.out.println(HDevices+'\t'+c);
			System.out.println(SS);
			System.out.println(SC+'\t'+'\t'+b);
			System.out.println(Mother+'\t'+b);
			System.out.println(AW+'\t'+c);
			System.out.println(Fit+'\t'+c);
			System.out.println(AC+'\t'+'\t'+a);
			System.out.println(Diabtic+'\t'+'\t'+b);
		...
		void Appointment()
		{
			...
			System.out.println(Time+Doctor_Timing_Starts+"am "+"-"+Doctor_Timing_End+"pm"+'\n'+'\n');
		}
	...
	public static void main(String[] args) {
		...
		Healthcare obj = new Healthcare("Kumar",2585);
		obj.MedicinesTypes();
		obj.Medicinesorder();
		obj.Healthcare();
		obj.LabTest();
