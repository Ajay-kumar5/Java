...
public class Shopping {
		...
		Shopping(String Username,int ID)
		{
			...
			System.out.println("Username: "+Username+'\t'+'\t'+"ID:"+ID+'\t'+'\t'+Wishlist+'\t'+'\t'+order+'\n');
		}
		
		void offers(int x,int y,int z)
		{
			this.x =x;
			this.y = y;
			this.z = z;
			
			System.out.println("Offers Starts@ "+x+","+y+","+z+'\n');
		}
		...
		void Order()
		{
			...
			String Delivery = "09-may-2024";
			String Address = "Salam";
			int Totalrate = 599;
